'use strict';
const CACHE_VERSION = 'wellone-customer-v101-professional-filters-product-view';
...
const SHELL_ASSETS = [
  ...
  './css/style.css?v=101', './js/store.bundle.js?v=101', './js/wishlist.js?v=101', './js/basic.bundle.js?v=99',
