'use strict';
const CACHE_VERSION = 'wellone-customer-v97-complicated-variant-orders';
...
const SHELL_ASSETS = [
  ...
  './css/style.css?v=97', './js/store.bundle.js?v=97', './js/basic.bundle.js?v=97',
  './js/orders.bundle.js?v=97', './js/pwa-install.js?v=97', './manifest.webmanifest',
  './assets/logo.png?v=97', './assets/favicon/favicon.ico',
