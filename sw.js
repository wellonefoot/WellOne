'use strict';
const CACHE_VERSION = 'wellone-customer-v104-search-filter-availability';
...
const SHELL_ASSETS = [
  ...
  './css/style.css?v=104', './js/store.bundle.js?v=104', './js/wishlist.js?v=104', './js/basic.bundle.js?v=99',
  './js/orders.bundle.js?v=104', './js/pwa-install.js?v=104', './manifest.webmanifest',
