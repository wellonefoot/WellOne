'use strict';
const CACHE_VERSION = 'wellone-customer-v100-wishlist-options-barcode';
...
const SHELL_ASSETS = [
  ...
  './css/style.css?v=100', './js/store.bundle.js?v=100', './js/wishlist.js?v=100', './js/basic.bundle.js?v=99',
